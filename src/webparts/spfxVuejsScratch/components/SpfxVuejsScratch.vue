<template>
    <div :class="$style.SpfxVuejsScratch">
        <div :class="$style.container">
            <div :class="$style.row">
                <div :class="$style.column">
                    ...
                    <p :class="$style.description">{{other}}</p>
 ...
 */
export interface ISpfxVuejsScratchProps {
    description: string;
    other: string;
}
 ...
 */
@Component
export default class SpfxVuejsScratch extends Vue implements ISpfxVuejsScratchProps {
